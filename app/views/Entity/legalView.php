...
<div class="card">
    ...
    <div class="card-header">
        <a href="<?= PATH ?>/entity/add/?type=legal" class="btn btn-default btn-flat"><i class="fas fa-plus"></i> Добавить новое юридическое лицо</a>
    </div>
    <?php } ?>
                ...
                <table class="table table-bordered">
                    ...
                    <?php foreach ($entities as $entity): ?>
                        <tr <?php if ($entity['id']) echo 'class=""' ?>>
                            ...
                            <?php if($_SESSION['user']['role'] == 'superadmin' OR $_SESSION['user']['role'] == 'admin') { ?>
                            <td width="50">
                                <a class="btn btn-info btn-sm" href="<?= PATH ?>/addexpenses/<?= $entity['id']?>/?type=1">
                            ...
                            <td width="50">
                                <a class="btn btn-info btn-sm"
                                   href="<?= PATH ?>/viewexpenses/<?= $entity['id']?>/?type=1">
